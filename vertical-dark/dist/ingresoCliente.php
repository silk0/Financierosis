...
<SCRIPT language=JavaScript>
    ...
    function go() {
        ...
        if (document.getElementById('nombre').value == "") {
            ...
            notify(' Advertencia:', 'Es necesario por lo menos un numero de telefono', 'top', 'right', 'any',
                'warning');
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                ...
                                <form  method="POST" action="IngresoCliente.php" required
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="nit" id="nit" required
                                                data-mask="9999-999999-999-9" placeholder="9999-999999-999-9">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="telefono" id="telefono"
                                                required data-mask="9999-9999" placeholder="9999-9999">
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4" class="col-form-label">Profesion u
                                                oficio</label>
                                            <input type="text" class="form-control" name="profecion" id="profecion"
                                                required placeholder="Rodriguez Perez">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="inputZip" class="col-form-label">Egreso Promedio Mensual
                                                ($)</label>
                                            <input type="number" class="form-control" name="egreso" id="egreso"
                                                placeholder="0.00">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="fia" id="fia">
                                            <option value='0' selected>Seleccione</option>
                                                <?php
                                                   include 'config/conexion.php';
...
<?php
   ...
   // $accion = $_REQUEST['bandera'];
        ...
        $fiador  = $_POST['fia'];
        msgI($egreso);
        $consulta  = "INSERT INTO tclientes (id_cartera,nombre,apellido,direccion,dui,nit,profecion,
        tipo_ingreso,salario,telefono,celular,correo,observaciones,egreso,id_fiador) VALUES('$cartera','$nombre',
        '$apellido','$direccion','$dui','$nit','$prof','$tipo','$salario','$tel','$cel','$email','$observ','$egreso','$fiador')";
        ...
        echo '<script>location.href="ingresoCliente.php";</script>';
    }
function msgI($texto)
{
