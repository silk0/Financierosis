                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                ...
                                <form name="form" method="post" action="ingresoEmpleado.php?bandera=1"  class="parsley-examples">
                                <input type="hidden" id="idfiador" name="idfiador">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="password" class="form-control" name="contra" id="contra" required  placeholder="xxxxxx">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword4" class="col-form-label">Repetir Contraseña</label>
                                            <input type="password" class="form-control" name="contra1" id="contra1" required  placeholder="xxxxxx">
                                        </div>
                                    </div>
                                    </br>
                                    <div class="form-row"> 
