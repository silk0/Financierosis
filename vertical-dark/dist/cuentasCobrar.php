...
<body>
    ...
    <div id="wrapper">
        ...
        update tventas v set v.saldo_actual= (select 248.20-truncate(sum(monto),2)+truncate(sum(mora),2) from tpago where id_venta=28 and estado=1)
        where v.id_venta = 28;
        select truncate(sum(monto),2)+truncate(sum(mora),2) from tpago where id_venta=28
        group by id_venta;
