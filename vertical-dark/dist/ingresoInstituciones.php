            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <form id="fInstitucion" name="fInstitucion" action="" method="GET"
                    ...
                    <div class="row">
                                                            ...
                                                            <form action="ingresoInstituciones.php" method="POST"
                                                                ...
                                                                <div class="form-row">
                                                                    <?php 
                                                                        ...
                                                                        if ($result) {
                                                                            while ($fila = $result->fetch_object()) {                                               
                                                                                $codigoR=str_pad($fila->Auto_increment, 4, "100", STR_PAD_LEFT);
                                                                                echo'
                        ...
                        <!--  Modal MOSTRAR INSTITUCION-->
                        <div id="mostrarInstitucion" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
                            aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                        ...
                        <div id="editarInstitucion" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h4 class="modal-title">Editar Datos Institucion
                                        </h4>
                                        <button type="button" class="close" data-dismiss="modal"
                                            aria-hidden="true">×</button>
                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-box">
                                                    <form name="editarForm" id="editarForm" method="post"
                                                        action="scriptsphp/modificarInstitucion.php?bandera=1" required
                                                        class="parsley-examples">
                                                                            ...
                                                                            while ($fila = $result->fetch_object()) {                                               
                                                                                ...
                                                                                <div class="form-group col-md-4">
                                                                                    <label for="inputEmail4"
                                                                                        class="col-form-label">Correlativo</label>
                                                                                    <input type="text" class="form-control"
                                                                                        name="correlativoo" id="correlativoo" value ="'.$codigoR.'" required placeholder="0000" readonly>
                                                                                </div>
                                                                                ';
                                                                            }
                                                                        } 
