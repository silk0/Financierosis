                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title" id="myLargeModalLabel">Datos de Clasificaciòn de Activo
                                                </h4>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            placeholder="Nombre de Clasificaciòn">
                                                                    </div>
                                                                    <div class="form-group col-md-6">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            data-mask="9999" placeholder="9999">
                                                                    </div>
                                                                </div>
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-6">
                                                                        <label for="inputPassword4"
                                                                            class="col-form-label">Depresiaciòn</label>
                                                                        <input type="text" class="form-control"
                                                                            name="number" id="celular" required 
                                                                             placeholder="Años de Depresiaciòn">
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
